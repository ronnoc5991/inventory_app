...
function createCategories(cb) {
    async.series([
        function(callback) {
            categoryCreate('Category 1', 'Test Category 1', callback);
        },
        function(callback) {
            categoryCreate('Category 2', 'Test Category 2', callback);
        },
        function(callback) {
            categoryCreate('Category 3', 'Test Category 3', callback);
        },
        function(callback) {
            categoryCreate('Category 4', 'Test Category 4', callback);
        },
        function(callback) {
            categoryCreate('Category 5', 'Test Category 5', callback);
        },
    ], cb);
}
...
function createItems(cb) {
    async.parallel([
        function(callback) {
            itemCreate('Test Item 1', 'Test item 1 description', categories[0], 100, 10, callback)
        },
        function(callback) {
            itemCreate('Test Item 2', 'Test item 2 description', categories[1], 100, 10, callback)
        },
        function(callback) {
            itemCreate('Test Item 3', 'Test item 3 description', categories[2], 100, 10, callback)
        },
        function(callback) {
            itemCreate('Test Item 4', 'Test item 4 description', categories[3], 100, 10, callback)
        },
        function(callback) {
            itemCreate('Test Item 5', 'Test item 5 description', categories[4], 100, 10, callback)
        },
    ], cb)
}
